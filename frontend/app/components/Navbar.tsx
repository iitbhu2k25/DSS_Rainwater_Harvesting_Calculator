                        ...
                        if (typeof sub === 'string') {
                          ...
                          return (
                            <li key={i} className=" block px-4 py-2 text-blue-600 font-semibold hover:bg-blue-50 hover:bg-opacity-10 rounded-md transition duration-200whitespace-nowrap relative group/nested mb-0">
                              ...
                              {sub.nestedMenu && (
                                <ul className="w-full bg-white text-blue rounded shadow-md opacity-0 invisible group-hover/nested:opacity-100 group-hover/nested:visible transition-opacity duration-300 z-1000 pl-4 lg:pl-0 lg:absolute lg:left-full lg:top-0 lg:w-max">
                                  {sub.nestedMenu.map((nested: { href: string | UrlObject; label: string | number | bigint | boolean | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | ReactPortal | Promise<string | number | bigint | boolean | ReactPortal | ReactElement<unknown, string | JSXElementConstructor<any>> | Iterable<ReactNode> | null | undefined> | null | undefined; }, j: Key | null | undefined) => (
