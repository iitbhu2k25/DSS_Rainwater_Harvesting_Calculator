  ...
  return (
    <div className="min-h-screen w-full flex flex-row bg-white">
      ...
      <div className="w-3/4 relative m-4 border border-gray-300 rounded-2xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-xl">
       {/* // Add this section in your left panel, after the mode selection and before the error section */}
  ...
  <div className="flex items-start space-x-2">
    ...
    <div>
      ...
      <p className="text-sm text-blue-700">
        Click anywhere on the map to place a marker, then click the blue icon then "Delineate" button in the popup to analyze the {mode === 'upstream' ? 'watershed and river network' : 'downstream flowpath'} for that location.
      </p>
    </div>
  </div>
</div>
