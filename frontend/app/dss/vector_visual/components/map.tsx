...
return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute inset-0 z-10 pointer-events-none">
        {/* Coordinates Display */}
       <div
  className="fixed bottom-[96px] left-1/2 -translate-x-1/2 bg-white/90 rounded-[16px] shadow-xl backdrop-blur-sm pointer-events-auto z-50"
  style={{
    padding: '16px 32px',
    fontSize: '18px',
    fontWeight: '600',
...
>
  <span className="text-gray-700">
    Lat: {coordinates.lat} | Lng: {coordinates.lng}
        ...
        {/* Map Controls */}
        <div className="absolute right-4 top-[480px] bg-white rounded-xl shadow-md flex flex-col p-[4px] pointer-events-auto z-50">
  <button
    onClick={handleZoomIn}
    className="hover:bg-blue-500 hover:text-white rounded-lg flex items-center justify-center transition-colors"
  ...
  <button
    onClick={() => setBufferToolVisible(!bufferToolVisible)}
    className="hover:bg-blue-500 hover:text-white rounded-lg flex items-center justify-center transition-colors"
    style={{ width: '48px', height: '48px', fontSize: '20px' }}
    title="Buffer Tool"
  >
